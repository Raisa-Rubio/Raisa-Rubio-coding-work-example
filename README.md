...
clear 
set more off
import excel "C:\Users\raisa\OneDrive\Documents\Lund\Thesis\Thesis 2\Data\INEI_sectoral panel.xlsx", sheet("Panel variables") firstrow
preserve

drop Region
label variable regioncode "Region - Includes Callao & Lima Metropolitana"
label define regioncode 1 "Amazonas" 2 "Ancash" 3 "Apurimac" 4 "Arequipa" 5 "Ayacucho" 6 "Cajamarca" 7 "Callao" 8 "Cusco" ///
9 "Huancavelica" 10 "Huanuco" 11 "Ica" 12 "Junin" 13 "La Libertad" 14 "Lambayeque" 16 "Loreto" 17 "Madre de Dios" ///
18 "Moquegua" 19 "Pasco" 20 "Piura" 21 "Puno" 22 "San Martin" 23 "Tacna" 24 "Tumbes" 25 "Ucayali" 26 "Lima Provincias" 27 "Lima Metropolitana"
